...
INSERT INTO `proveedores` (`id`, `nom`, `tel`, `dir`, `email`, `precio`, `producto`) VALUES
(1, 'Prueba', 111111, 'test', 'test@test.com', 2500, 'Logitech G935'),
(2, 'test', 88888, 'test', 'test@test2.com', 5000, 'RX 6750 XT'),
(3, 'Manuel', 8295554444, 'Calle #1', 'manny6114@gmail.com', 1000, 'WTF'),
(4, 'CENTRAL', 555555, 'dasasas', 'centralgames77@gmail.com', 750, 'SDW');
...
(17, 'welcome_message', '<p>Hola, ¿En qué te puedo ayudar?</p>'),
...
INSERT INTO `tbl_coupon` (`id_coupon`, `coupon_code`, `discount`, `date_ends`, `status`) VALUES
(1, 'PR6KPQL23U', 5, '2023-04-29', b'1');
...
(13, 'Furgencio', '77777', 'centralgames77@gmail.com', '7777777', 59, '7777777777', 'Santiago', 'Santiago', '51000', 'Furgencio', 'DDD', '888888888', 59, 'sadaas', 'Santiago', 'Santiago', '51000', 'Furgencio', 'DDD', '888888888', 59, 'sadaas', 'Santiago', 'Santiago', '51000', 'b37a4e8331c6dfb818bf5f8551bef6ab', 'f535665c05f72f84beb936bcde894d59', '2023-04-17 04:44:15', '1681775055', 1);
...
(9, 'Product', 'producto enviado y entregado!', '\nCustomer Name: Furgencio<br>\nCustomer Email: centralgames77@gmail.com<br>\nPayment Method: Bank Deposit<br>\nPayment Date: 2023-04-23 13:33:38<br>\nPayment Details: <br>\nTransaction Details: <br>8856412356<br>\nPaid Amount: 595<br>\nPayment Status: Completed<br>\nShipping Status: Completed<br>\nPayment Id: 1682282018<br>\n            \n<br><b><u>Product Item 1</u></b><br>\nProduct Name: Oculus Quest 2 - Advanced All-In-One Virtual Reality Headset<br>\nSize: 256 GB<br>\nColor: White<br>\nQuantity: 1<br>\nUnit Price: 495<br>\n            ', 13);
...
--
-- Table structure for table `tbl_gama`
--

CREATE TABLE `tbl_gama` (
...
--
-- Dumping data for table `tbl_gama`
--

INSERT INTO `tbl_gama` (`id_categoria`, `nombre`, `min_range`) VALUES
(1, 'Gama baja', 10),
(2, 'Gama media', 20),
(3, 'Gama alta', 30);
...
--
-- Table structure for table `tbl_gama_vs_product`
--

CREATE TABLE `tbl_gama_vs_product` (
  `id_categoria` int(11) NOT NULL,
  `id_product` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbl_gama_vs_product`
--

INSERT INTO `tbl_gama_vs_product` (`id_categoria`, `id_product`) VALUES
(3, 111),
(1, 112),
(2, 113);
...
--
-- Table structure for table `tbl_loyalty_points_vs_clientes`
--

CREATE TABLE `tbl_loyalty_points_vs_clientes` (
  `id_customer` int(11) NOT NULL,
  `points` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbl_loyalty_points_vs_clientes`
--

INSERT INTO `tbl_loyalty_points_vs_clientes` (`id_customer`, `points`) VALUES
(13, 2);
...
(6, 99, 'Oculus Quest 2 - Advanced All-In-One Virtual Reality Headset', '256 GB', 'White', '1', '495', '1682282018'),
(7, 86, 'Amazfit GTS 3 Smart Watch for Android iPhone', 'Free Size', 'Black', '1', '164', '1682289192'),
(8, 86, 'Amazfit GTS 3 Smart Watch for Android iPhone', 'Free Size', 'Black', '1', '164', '1682293188'),
(9, 95, 'Bose QuietComfort 45 Bluetooth Wireless Headphones', 'One Size for All', 'Black', '1', '264', '1682293304'),
(19, 103, 'Logitech G935', 'M', 'Black', '1', '35', '1682301983');
...
(56, 13, 'Furgencio', 'centralgames77@gmail.com', '2023-04-23 13:33:38', '', 595, '', '', '', '', '8856412356', 'Bank Deposit', 'Completed', 'Completed', '1682282018'),
(57, 13, 'Furgencio', 'centralgames77@gmail.com', '2023-04-23 15:33:12', '', 264, '', '', '', '', 'asasasadsa', 'Bank Deposit', 'Completed', 'Completed', '1682289192'),
...
(60, 13, 'Furgencio', 'centralgames77@gmail.com', '2023-04-23 16:39:48', '', 264, '', '', '', '', 'asasasasasa', 'Bank Deposit', 'Completed', 'Completed', '1682293188'),
(61, 13, 'Furgencio', 'centralgames77@gmail.com', '2023-04-23 16:41:44', '', 364, '', '', '', '', 'asasasasa', 'Bank Deposit', 'Completed', 'Completed', '1682293304'),
(72, 13, 'Furgencio', 'centralgames77@gmail.com', '2023-04-23 19:06:23', '', 135, '', '', '', '', 'sasasasasa', 'Bank Deposit', 'Completed', 'Completed', '1682301983'),
(73, 13, 'Furgencio', 'centralgames77@gmail.com', '2023-04-23 19:15:11', '', 135, '', '', '', '', 'asasaasas', 'Bank Deposit', 'Completed', 'Completed', '1682302511');

--
-- Triggers `tbl_payment`
--
DELIMITER $$
CREATE TRIGGER `points` AFTER INSERT ON `tbl_payment` FOR EACH ROW BEGIN
DECLARE puntos integer;
DECLARE points_old integer;
DECLARE val integer;
SET puntos = 0;
SET val = (SELECT id_customer FROM tbl_loyalty_points_vs_clientes WHERE id_customer = NEW.customer_id);

IF val>0 THEN
SET points_old = (SELECT points FROM tbl_loyalty_points_vs_clientes WHERE id_customer = val) +1;
UPDATE tbl_loyalty_points_vs_clientes SET points = points_old WHERE id_customer = val;
ELSE
SET puntos = puntos+1;
INSERT INTO tbl_loyalty_points_vs_clientes VALUES(NEW.customer_id,puntos);
END IF;
...
CREATE TABLE `tbl_points` (
  ...
  `name_points` varchar(50) NOT NULL,
...
INSERT INTO `tbl_points` (`id_points`, `name_points`, `parameters`, `points`) VALUES
(1, 'Camara low', 3, 2),
(2, 'Disk space low', 125, 2),
(3, 'Año de manufactura low', 2008, 2),
(4, 'Processor Freq. low', 2, 2),
(5, 'RAM GB', 4, 2),
(6, 'Camara mid', 8, 4),
(7, 'Disk space mid', 512, 4),
(8, 'Año de manufactura mid', 2015, 4),
(9, 'Processor Freq. mid', 3, 4),
(10, 'RAM GB MID', 8, 4),
(11, 'Camara high', 12, 6),
(12, 'Disk space high', 1000, 6),
(13, 'Año de manufactura high', 2020, 6),
(14, 'Processor Freq. high', 4, 6),
(15, 'RAM GB HIGH', 16, 6);
...
CREATE TABLE `tbl_product` (
  ...
  `processorghz` float DEFAULT NULL,
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `STOCKVALID` AFTER UPDATE ON `tbl_product` FOR EACH ROW BEGIN

DECLARE contador integer;

SET contador = (SELECT count(*) FROM tbl_product_vs_stocklimit WHERE id_product = OLD.p_id);




IF (contador<=0) AND (NEW.p_qty < (select MinStock from tbl_stockrange))  THEN
insert into tbl_product_vs_stocklimit values(OLD.p_id,1);



ELSEIF (contador>=0) AND (NEW.p_qty > (select MinStock from tbl_stockrange))  THEN
DELETE FROM tbl_product_vs_stocklimit WHERE id_product = OLD.p_id;
...
--
-- Table structure for table `tbl_product_vs_stocklimit`
--

CREATE TABLE `tbl_product_vs_stocklimit` (
  `id_product` int(11) NOT NULL,
  `Id_range_stock` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbl_product_vs_stocklimit`
--

INSERT INTO `tbl_product_vs_stocklimit` (`id_product`, `Id_range_stock`) VALUES
(102, 1);
...
--
-- Table structure for table `tbl_season_offers`
--

CREATE TABLE `tbl_season_offers` (
...
--
-- Dumping data for table `tbl_season_offers`
--

INSERT INTO `tbl_season_offers` (`id_sf`, `description`, `date_start`, `date_end`, `discounts`, `categoria`) VALUES
(2, 'Dia de las madres', '2023-04-04', '2023-04-29', 30, 'Kids');
...
--
-- Table structure for table `tbl_stockrange`
--

CREATE TABLE `tbl_stockrange` (
  `Id_range` int(11) NOT NULL,
  `MinStock` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbl_stockrange`
--

INSERT INTO `tbl_stockrange` (`Id_range`, `MinStock`) VALUES
(1, 20);
...
(1, 'Administrator', 'admin@mail.com', '7777777777', 'b37a4e8331c6dfb818bf5f8551bef6ab', 'user-1.png', 'Super Admin', 'Active'),
(2, 'Christine', 'christine@mail.com', '4444444444', '81dc9bdb52d04dc20036dbd8313ed055', 'user-13.jpg', 'Admin', 'Active'),
(3, 'Manny', 'manny6114@gmail.com', '7775557', '02536189', 'asasasas', 'Super Admin', 'Active');
...
INSERT INTO `ticket` (`id_ticket`, `asignado`, `descripcion`, `fecha_generado`, `estado`) VALUES
(2, 'test@test.com', 'Tengo un problema con los headsets, me llegaron defectuosos.', '2023-04-26', 1),
(3, '', '', '2023-04-26', 1),
(4, '', '', '2023-04-26', 1),
(5, '', '', '2023-04-26', 1),
(6, '', '', '2023-04-26', 1),
(7, '', '', '2023-04-26', 1),
(8, '', '', '2023-04-26', 1),
(9, 'centralgames77@gmail.com', 'Prueba\r\n', '2023-04-26', 1),
(10, '', '', '2023-04-26', 1),
(11, '', '', '2023-04-26', 1),
(12, '', '', '2023-04-26', 1),
(13, '', '', '2023-04-26', 1),
...
(18, '', '', '2023-04-26', 1),
(19, '', '', '2023-04-26', 1),
(20, 'centralgames77@gmail.com', 'Test', '2023-04-26', 1);
...
--
-- Indexes for table `tbl_gama`
--
ALTER TABLE `tbl_gama`
...
--
-- Indexes for table `tbl_season_offers`
--
ALTER TABLE `tbl_season_offers`
...
--
-- Indexes for table `tbl_stockrange`
--
ALTER TABLE `tbl_stockrange`
...
--
-- AUTO_INCREMENT for table `tbl_gama`
--
ALTER TABLE `tbl_gama`
...
--
ALTER TABLE `tbl_points`
  MODIFY `id_points` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
-- AUTO_INCREMENT for table `tbl_season_offers`
--
ALTER TABLE `tbl_season_offers`
...
--
-- AUTO_INCREMENT for table `tbl_stockrange`
--
ALTER TABLE `tbl_stockrange`
